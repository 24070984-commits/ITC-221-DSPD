[README.md](https://github.com/user-attachments/files/23449836/README.md)
DSPD Practical Aim:
...
8  Write program to implement Kruskal's Algorithm in graph to find the Minimum Spanning Tree (MST) of a connected, weighted, and undirected graph.
